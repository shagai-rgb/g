...
//       <div
//         className={cn(
//           "flex flex-col md:flex-row items-center bg-gradient-to-r",
//           gradient
//         )}
//       >
//         {/* Зураг болон хямдралын хаяг */}
//         <div className="relative w-full md:w-1/3 mb-6 md:mb-0">
//           {/* {discountPercentage && (
//             <span className="absolute top-0 left-0 bg-purple-600 text-white px-2 py-1 rounded-br-lg">
//               -{discountPercentage}%
//             </span>
//           )} */}
//           <img
...
//         <div className="w-1/3">
//           {/* Контент хэсэг */}
//           <div className="w-full md:w-2/3 md:pl-6 text-white">
...
//                 <div
//                   key={index}
//                   className={`${timerBgColor} ${borderRadius} p-2 text-center`}
//                 >
...
//               <div className={`${priceSize} font-bold`}>
//                 {formatPrice(finalPrice)}
//               </div>
//               <button
//                 onClick={onButtonClick}
//                 className={`${buttonColor} text-white ${buttonSize} ${borderRadius} transition`}
//               >
//                 {buttonText}
//               </button>
//             </div>
